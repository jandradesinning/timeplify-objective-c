    ...
    try
    {
        ...
        if(bOK) {
            ...
            getSettings().then(function(settings){
                ...
                return getRealTimeData(routeId, stationId, direction, returns[0].realTimeFeedTime, returns[0].serviceStatusFeedTime, 0);
            }).then(function(realTimeData){
                returns.push(realTimeData);
                return fetchScheduledData ? getScheduledData(routeId, stationId, direction, returns[0].staticFeedTime, returns[0].serviceStatusFeedTime, 0, returns[1], returns[2]) : null;
            }).then(function(scheduledData){                
